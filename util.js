...
const getSocialLoginUrl = (providerType) => {
  return `${process.env.BACKEND_URL}/oauth2/authorization/${providerType}?redirect_uri=${process.env.FRONTEND_URL}/oauth/redirect`
}
...
export { smartUrl, loadKakaoSdk, loadChannelIOScript, bootChannelIO, getSocialLoginUrl, getSocialImage }