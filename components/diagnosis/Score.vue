          ...
          v-tab-item
            .progress-item
              span.progress-label
                ...
                |  치명
              .dignosis-progress
                v-progress-linear(:value='failed' color='#f63842' height='20' rounded)
                  strong {{ failed }}%
            .progress-item
              span.progress-label
                ...
                |  경고
              .dignosis-progress
                v-progress-linear(:value='warning' color='#ffab00' height='20' rounded)
                  strong {{ warning }}%
            .progress-item
              span.progress-label
                ...
                |  통과
              .dignosis-progress
                v-progress-linear(:value='passed' color='#34bc6e' height='20' rounded)
                  strong {{ passed }}%
          v-tab-item
            .progress-item
              span.progress-label
                strong 메타 명세서
              .dignosis-progress
                v-progress-linear(:value='meta' color='#00afff' height='20' rounded)
                  strong.white--text {{ meta }}%
            .progress-item
              span.progress-label
                strong 페이지 품질
              .dignosis-progress
                v-progress-linear(:value='quality' color='#00afff' height='20' rounded)
                  strong.white--text {{ quality }}%
            .progress-item
              span.progress-label
                strong 페이지 구조
              .dignosis-progress
                v-progress-linear(:value='structure' color='#00afff' height='20' rounded)
                  strong.white--text {{ structure }}%
            .progress-item
              span.progress-label
                strong 링크 구조
              .dignosis-progress
                v-progress-linear(:value='link' color='#00afff' height='20' rounded)
